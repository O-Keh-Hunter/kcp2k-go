...
func (c *YamlConfig) GetTestDuration() (time.Duration, error) {
	return time.ParseDuration(c.Test.Duration)
}

// GetWarmupDuration 获取预热时间
func (c *YamlConfig) GetWarmupDuration() (time.Duration, error) {
	return time.ParseDuration(c.Test.Warmup)
}

// GetCooldownDuration 获取冷却时间
func (c *YamlConfig) GetCooldownDuration() (time.Duration, error) {
